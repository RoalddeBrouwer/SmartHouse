...
def on_message(client, userdata, msg):
        ...
        if msg_count == 1:
            ...
            # get the data from the message --> Payload Dash7 
            getData = result.actions.__getitem__(0)
            getData = getData.operand.data
            # print(getData)

            # turn 4 bytes into floats and remove brackets 
            des = getData[0] - 48;
            des2 = getData[1] - 48;
...
ACCESS_TOKEN = 'qgKhFBFpiPJ8QiSkFaMk'  # Token of your device
