...
app_id = "satish_labo1_testproject"
access_key = "ttn-account-v2.Rqy6ccoeCMNjrUQ_zpfrIdMyMmoDx2xk5C_yMOiSRO0"
dev_id = "satishloradev"
gatewayList = ["4337313400210032", "433731340023003d", "42373434002a0049", "463230390032003e"]
rx_values = [0, 0, 0, 0]
receivedList = []
count = 0
ACCESS_TOKEN = 'qgKhFBFpiPJ8QiSkFaMk'  # Token of your device on thingsboard
