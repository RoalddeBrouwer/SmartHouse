...
def localize(rx_values, k):
    ...
    for document in collection.find():
        ...
        print('diff = ' + str(diff) + 'which gives an rms = ' + str(rms))
...
#print localize (rx_values , 7) # make sure that the input of rx_values is in the correct order!
